...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RatingItem.author'
        db.add_column('ratings4you_ratingitem', 'author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)

        # Removing unique constraint on 'RatingItem', fields ['rating']
        db.delete_unique('ratings4you_ratingitem', ['rating_id'])


    def backwards(self, orm):
        
        # Deleting field 'RatingItem.author'
        db.delete_column('ratings4you_ratingitem', 'author_id')

        # Adding unique constraint on 'RatingItem', fields ['rating']
        db.create_unique('ratings4you_ratingitem', ['rating_id'])
