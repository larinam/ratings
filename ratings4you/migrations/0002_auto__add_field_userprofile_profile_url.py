...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.profile_url'
        db.add_column('ratings4you_userprofile', 'profile_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.profile_url'
        db.delete_column('ratings4you_userprofile', 'profile_url')
