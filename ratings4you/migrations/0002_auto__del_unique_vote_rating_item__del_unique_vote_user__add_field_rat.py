...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Vote', fields ['rating_item']
        db.delete_unique('ratings4you_vote', ['rating_item_id'])

        # Removing unique constraint on 'Vote', fields ['user']
        db.delete_unique('ratings4you_vote', ['user_id'])

        # Adding field 'Rating.author'
        db.add_column('ratings4you_rating', 'author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding unique constraint on 'Vote', fields ['rating_item']
        db.create_unique('ratings4you_vote', ['rating_item_id'])

        # Adding unique constraint on 'Vote', fields ['user']
        db.create_unique('ratings4you_vote', ['user_id'])

        # Deleting field 'Rating.author'
        db.delete_column('ratings4you_rating', 'author_id')
